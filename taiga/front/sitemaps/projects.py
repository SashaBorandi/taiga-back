...
class ProjectBacklogsSitemap(Sitemap):
    def items(self):
        ...
        # Only if anon users can view USs and Milestones
        queryset = queryset.filter(anon_permissions__contains=["view_us", "view_milestones"])
...
class ProjectKanbansSitemap(Sitemap):
    def items(self):
        ...
        # Only if anon users can view USs
        queryset = queryset.filter(anon_permissions__contains=["view_us"])
...
class ProjectIssuesSitemap(Sitemap):
    def items(self):
        ...
        # Only if anon users can view issues
        queryset = queryset.filter(anon_permissions__contains=["view_issues"])

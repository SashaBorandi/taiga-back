...
class TasksSitemap(Sitemap):
    def items(self):
        ...
        # Exclude tasks from projects without kanban and backlog
        queryset = queryset.exclude(project__is_backlog_activated=False, project__is_kanban_activated=False)
